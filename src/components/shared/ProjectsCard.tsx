    ...
    return (
        <div className='group'>
            ...
            >
                ...
                <Link href={liveLink} target='_blank' className='bg-primary bg-opacity-80 p-2 w-[50%] absolute text-white  -top-full group-hover:top-[90%] duration-200 left-[50.5%] hover:bg-blue-700'>
                    View Live
                </Link>
            </motion.div>
